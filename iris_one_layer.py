...
W3 = tf.Variable(np.float32(np.random.rand(3, 3))*0.1)
b3 = tf.Variable(np.float32(np.random.rand(3))*0.1)

#W4 = tf.Variable(np.float32(np.random.rand(3, 3))*0.1)
#b4 = tf.Variable(np.float32(np.random.rand(3))*0.1)

#r3 = tf.nn.sigmoid(tf.matmul(r1, W3) + b3)

y = tf.nn.softmax(tf.matmul(r2, W3) + b3)
